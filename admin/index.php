    ...
    <div class="admin-page">
      <header class="admin-header">
        ...
        <div class="admin-actions">
          ...
          <a class="button" href="create.php">Add Profile</a>
        </div>
      </header>
                ...
                <tr>
                  ...
                  <td>
                    <div class="table-actions">
                      <a class="link" href="edit.php?id=<?php echo (int) $profile['id']; ?>">Edit</a>
                      <form method="post" action="delete.php" onsubmit="return confirm('Delete this profile?');">
